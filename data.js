...
export const drawbacks = [
    ...
    { name: "Strength Down", prob: 0.2 },
    { name: "Dexterity Down", prob: 0.2 },
    { name: "Constitution Down", prob: 0.2 },
    { name: "Intelligence Down", prob: 0.2 },
    { name: "Wisdom Down", prob: 0.2 },
    { name: "Charisma Down", prob: 0.2 },
